...
function findRecipes() {
    ...
    const query = state.checked.join(' ');
    window.open('https://cooking.nytimes.com/search?q=' + encodeURIComponent(query), '_blank');
}
...
document.getElementById('recipe-btn').addEventListener('click', findRecipes);
